...
for line in stream:
    ...
    if ScoreExpect_line:
        ...
        Identities_line =  re.search(
                      r'^Identities =+ \S+ \((\S+)%\)',
                      line)
# relIdentities ist immer ein string, nicht ein Zahl, darüberhinaus kann
# das relIdent_dict falsch sein wegen leerzeichen in string. -0.5  #A: wie kann sich mit (\S+) hier Lerrzeichen reinschleichen?
